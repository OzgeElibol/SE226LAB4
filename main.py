...
print(myEmptyList)
print(myEmptyList)
myEmptyList.append("Özge")
print(myEmptyList)
myEmptyList.append("Python")
print(myEmptyList)
myEmptyList.append("Guido van Rossum")
print(myEmptyList)
del myEmptyList[0]
print(myEmptyList)
myEmptyList.append("is the inventor of")
print(myEmptyList)
myEmptyList.pop(0)
print(myEmptyList)
...
print(words[0:1000])
for y in range(3):
    usernum = int(input("enter an integer between 3 and 7:"))
    if (usernum >= 3 and usernum <= 7):
        final = " "
